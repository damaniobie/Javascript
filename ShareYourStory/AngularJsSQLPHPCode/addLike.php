<?php  
 ...
 {  
     // $title = mysqli_real_escape_string($connect, $data->title);       
      ...
      $query = "INSERT INTO liked_stories (u_id,s_id) VALUES ('$u_id','$story_id')";  //Update stories SET Stars = Stars + 1 WHERE Story_id = '$story_id' doesn't work in the same query
